export default function AboutSection() {
  return (
    <section
      id="about"
      className="min-h-screen flex items-center justify-center px-6 py-24 scroll-mt-20 border-t border-border/60 bg-card/10"
      aria-labelledby="about-heading"
    >
      <div className="w-full max-w-6xl mx-auto">
        <div
          className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 auto-rows-[minmax(120px,auto)] lg:auto-rows-[160px]"
          role="list"
          aria-label="Posturai highlights"
        >
          <div
            role="listitem"
            ...
            <div className="relative flex h-full flex-col">
              <div>
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  Lightweight on-device tracking that nudges you before bad
                  habits set in.
                </p>
              </div>
              <div
                aria-label="analysis preview image placeholder"
                className="mt-4 flex-1 rounded-xl border border-border/60 bg-muted/10 shadow-inner flex items-center justify-center text-xs text-muted-foreground"
              >
                Image Placeholder
              </div>
            </div>
